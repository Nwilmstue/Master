...
#        self.TOTAL.append(['animation'                  ,False      ,'Build GIF animation'                      , 'Simulation options'])
        ...
        self.TOTAL.append(['maxiter'                    ,10         ,'amount of steps of the laser per layer '    , 'Time options']) 
        ...
        self.TOTAL.append(['dx1'                        ,0.1         ,'Distance in x1 direction in [m]'      , 'Geometry and topology'])
